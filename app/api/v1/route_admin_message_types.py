...
async def list_message_types(
    ...
    return await service.list_message_types(page, page_size)
...
async def create_message_type(
    ...
    service = MessageTypeService(db)
    return await service.create_message_type(payload)
...
async def update_message_type(
    ...
    service = MessageTypeService(db)
    return await service.update_message_type(type_id, payload)
